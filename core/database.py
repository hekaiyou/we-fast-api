        ...
        if not user_col.count_documents({}):
            ...
            if not role_result:
                role_result = role_col.insert_one({
                    ...
                    'permissions': ['read_permission_all', 'read_role_all', 'read_role', 'create_role', 'delete_role', 'update_role', 'create_user', 'read_user_page', 'delete_user', 'update_user', 'read_setup_module_all', 'read_setup', 'update_setup', 'read_logs_file'],
